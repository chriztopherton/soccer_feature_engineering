...
## Goal
Design and implement novel, interpretable soccer attributes (features) from play-by-play event data that describe team behavior, tactics, and performance beyond traditional box-score metrics.
